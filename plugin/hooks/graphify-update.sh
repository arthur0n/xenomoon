...
# `export XENODOT_GRAPHIFY_AUTOUPDATE=1`). Off by default so building a graph once never
...
[ -n "$XENODOT_GRAPHIFY_AUTOUPDATE" ] || [ -f "$out/.autoupdate" ] || exit 0
...
case "$fp" in
  */graphify-out/* | */.xenodot/* | */.claude/* | */.godot/* | */logs/*) exit 0 ;;
  graphify-out/* | .xenodot/* | .claude/* | .godot/* | logs/*) exit 0 ;;
esac
