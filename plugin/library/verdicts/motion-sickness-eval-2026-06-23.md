---
type: verdict
title: "Verdict — new-onset motion sickness (FPS, Arena) — 2026-06-23"
...
# Verdict — new-onset motion sickness (FPS, Arena) — 2026-06-23
...
4. **Glow config?** `arena.tscn` Env_bc: `glow_enabled=true`, `glow_intensity=0.3`, `glow_hdr_threshold=1.2` (LOW), `glow_blend_mode=2` (ADDITIVE), `tonemap_mode=2` (Filmic). Low threshold + bright noon → many surfaces over threshold → **flicker risk CONFIRMED**.
...
- **Comfort-respawn occlusion** — any hard camera teleport must occlude under full black (fade-in → HOLD black ≥0.1s → fade-out), OR lerp the camera. Reusable beyond Arena.
